 ...
 */
@Controller
public class JqueryDemoErrorController implements ErrorController {

    private static final Logger logger = LoggerFactory
            .getLogger(JqueryDemoErrorController.class);
    private final static String ERROR_PATH = "/error";
    private static JqueryDemoErrorController appErrorController;
    /**
    ...
    public JqueryDemoErrorController(ErrorAttributes errorAttributes) {
        this.errorAttributes = errorAttributes;
    }

    public JqueryDemoErrorController() {
        if (appErrorController == null) {
            appErrorController = new JqueryDemoErrorController(this.errorAttributes);
        }
    }
